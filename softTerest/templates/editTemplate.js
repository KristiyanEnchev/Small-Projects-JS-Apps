    ...
    <div class=" d-md-flex flex-mb-equal ">
        ...
        <form @submit=${submitHandler} class="form-idea col-md-5" action="/create" method="post">
            ...
            <div class="form-label-group">
                ...
                <textarea type="text" name="description" class="form-control" placeholder="Description" .value = ${data.description}></textarea>
            </div>
            <div class="form-label-group">
                <label for="inputURL">Add Image</label>
                <input type="text" id="imageURl" name="imageURL" class="form-control" placeholder="Image URL" .value = ${data.img}>
